...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-t from-blue-50 to-white pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-200">
          ...
          >
            <h4 className="text-xl font-semibold mb-4">СтаффПро</h4>
            <p className="text-muted-foreground mb-6">
              Профессиональный аутстафинг персонала для вашего бизнеса. Предоставляем квалифицированных сотрудников для различных задач.
            </p>
        ...
        <div className="pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            © {year} СтаффПро. Все права защищены. Аутстафинг персонала, грузчики на заказ, работники для склада, уборщики для офиса.
          </p>
        </div>
      </div>
    </footer>
