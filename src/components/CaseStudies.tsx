...
const testimonials = [
  ...
  },
  {
    ...
    position: "Управляющая рестораном 'Ривьера'",
    content:
      "Обращались в компанию для подбора временных официантов и кухонных работников на период высокого сезона. Сотрудники оказались хорошо обученными, вежливыми и быстро влились в наш коллектив. Отдельное спасибо менеджеру за оперативность в решении всех вопросов.",
    rating: 5,
...
const caseStudies = [
  ...
  },
  {
    ...
    description:
      "Обеспечиваем торговый центр персоналом на постоянной основе: охранники, уборщики, технический персонал. Гибкий график позволяет точно покрывать потребности в персонале в разное время суток и дни недели.",
